...
> = {
	...
	mintPrice: InitializeInstructionDataArgs["mintPrice"];
	initialUses: InitializeInstructionDataArgs["initialUses"];
	wagerExpirySeconds: InitializeInstructionDataArgs["wagerExpirySeconds"];
	vrfTimeoutSeconds: InitializeInstructionDataArgs["vrfTimeoutSeconds"];
};
